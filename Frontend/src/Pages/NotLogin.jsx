...
function NotLogin() {
  return (
    <section className="min-h-screen flex items-center min-w-screen justify-center px-4 py-12 from-rose-50 via-purple-50 to-indigo-50 dark:from-gray-900 dark:via-purple-950 dark:to-black">
      <div className="max-w-md w-full text-center bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-10 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Please log in to view and create memories.
          </p>
        </div>
